...
src-files := "main_app/main.cpp main_app/main_window.cpp main_app/pages/main_menu.cpp main_app/pages/GraphVisualizer.cpp widget_toolkit/input_box/InputBox.cpp widget_toolkit/notification/Notification.cpp widget_toolkit/pseudo_code_display/PseudoCode.cpp"
